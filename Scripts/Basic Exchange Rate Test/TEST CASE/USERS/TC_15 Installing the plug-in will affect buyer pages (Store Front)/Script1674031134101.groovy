...
WebUI.waitForElementClickable(findTestObject('Page_martintestforpackage/Search_button'), 0)

WebUI.click(findTestObject('Page_martintestforpackage/Search_button'))

WebUI.click(findTestObject('Page_martintestforpackage/coffee_item'))

WebUI.click(findTestObject('Page_martintestforpackage/a_Seller'))

WebUI.scrollToElement(findTestObject('Page_martintestforpackage/div_Item_for_sale'), 0)
