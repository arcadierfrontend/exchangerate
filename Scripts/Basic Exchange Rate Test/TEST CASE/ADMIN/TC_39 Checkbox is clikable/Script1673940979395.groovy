...
WebUI.waitForElementVisible(findTestObject('Page_martintestforpackage/label_Select All'), 0)

WebUI.verifyElementClickable(findTestObject('Page_martintestforpackage/label_Select All'))
