...
WebUI.waitForElementVisible(findTestObject('Exchange/Page_martintestforpackage/input_Original Currency of Marketplace_currency_marketplace'), 
    0)

WebUI.waitForElementAttributeValue(findTestObject('Exchange/Page_martintestforpackage/input_Original Currency of Marketplace_currency_marketplace'), 
    'value', 'United States Dollar (USD)', 1)
