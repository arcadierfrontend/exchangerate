...
WebUI.waitForElementPresent(findTestObject('Page_martintestforpackage/a_httpsopenexchangerates.org'), 0)

WebUI.verifyElementClickable(findTestObject('Page_martintestforpackage/a_httpsopenexchangerates.org'))

WebUI.click(findTestObject('Page_martintestforpackage/a_httpsopenexchangerates.org'))

WebUI.waitForElementPresent(findTestObject('Page_Open Exchange Rates/img'), 0)
