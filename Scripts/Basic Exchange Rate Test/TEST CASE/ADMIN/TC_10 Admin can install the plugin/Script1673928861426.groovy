...
WebUI.waitForElementVisible(findTestObject('Page_martintestforpackage/a_Available_Plugins'), 0)

WebUI.click(findTestObject('Page_martintestforpackage/a_Available_Plugins'), FailureHandling.STOP_ON_FAILURE)

WebUI.scrollToElement(findTestObject('Page_martintestforpackage/Install_Basic_Exchange_Rate'), 0)

WebUI.click(findTestObject('Page_martintestforpackage/a_Install'))

WebUI.click(findTestObject('Page_martintestforpackage/a_Install_Basic'))

WebUI.delay(3)

WebUI.waitForElementPresent(findTestObject('Page_martintestforpackage/Accept_Install'), 0)

WebUI.click(findTestObject('Page_martintestforpackage/Accept_Install'))
