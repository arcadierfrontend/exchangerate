...
scroll_present = WebUI.getCSSValue(findTestObject('Page_martintestforpackage/Dropdown_search'), 'overflow-x')

println(scroll_present)

WebUI.verifyEqual(scroll_present, 'visible')

WebUI.scrollToElement(findTestObject('Exchange/Page_martintestforpackage/Canadian_dollar'), 0)

WebUI.delay(5)

WebUI.scrollToElement(findTestObject('Exchange/Page_martintestforpackage/Argentine_peso'), 0)
