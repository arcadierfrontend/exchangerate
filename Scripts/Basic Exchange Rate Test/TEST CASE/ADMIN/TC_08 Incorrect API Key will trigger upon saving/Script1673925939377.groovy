...
WebUI.waitForElementVisible(findTestObject('Exchange/Page_martintestforpackage/API_Key_Field'), 0)

WebUI.setText(findTestObject('Exchange/Page_martintestforpackage/API_Key_Field'), '')

WebUI.setText(findTestObject('Exchange/Page_martintestforpackage/API_Key_Field'), 'dsfew342543')

WebUI.click(findTestObject('Exchange/Page_martintestforpackage/Save_Exchange'))

WebUI.waitForElementVisible(findTestObject('Exchange/Page_martintestforpackage/div_Incorrect API key'), 0)
