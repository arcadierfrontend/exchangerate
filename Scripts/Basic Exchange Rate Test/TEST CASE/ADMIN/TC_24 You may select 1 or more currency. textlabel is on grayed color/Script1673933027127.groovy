...
WebUI.waitForElementVisible(findTestObject('Page_martintestforpackage/span_(You may select 1 or more currency.)'), 0)

css_color = WebUI.getCSSValue(findTestObject('Page_martintestforpackage/span_(You may select 1 or more currency.)'), 'color')

println(css_color)

WebUI.verifyEqual(css_color, 'rgba(153, 153, 153, 1)')
