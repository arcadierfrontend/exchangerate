...
WebUI.verifyElementVisible(findTestObject('Exchange/Page_martintestforpackage/Save_Exchange'))

WebUI.scrollToElement(findTestObject('Exchange/Page_martintestforpackage/Save_Exchange'), 0)

WebUI.getAttribute(findTestObject('Exchange/Page_martintestforpackage/Save_Exchange'), '')

text_color = WebUI.getCSSValue(findTestObject('Exchange/Page_martintestforpackage/Save_Exchange'), 'color')

println(text_color)

WebUI.verifyEqual(text_color, 'rgba(255, 255, 255, 1)')

background_color = WebUI.getCSSValue(findTestObject('Exchange/Page_martintestforpackage/Save_Exchange'), 'background-color')

println(background_color)

WebUI.verifyEqual(background_color, 'rgba(80, 200, 255, 1)')
